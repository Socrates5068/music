            ...
            return (
                this.$element.find('option').each(function() {
                    ...
                    if (
                        ('' !== l && m && (l = '<span>' + l + '</span>'),
                            c.data('content') ||
                            (j = l + '<span class="text">' + j + k + '</span>'), !b.options.hideDisabled || !m)
                    )
                        if (
        ...
        render: function(b) {
            ...
            if (
                ...
                if (
                    ...
                    var i = this.$element
                        .find('option')
                        .not('[data-divider="true"], [data-hidden="true"]' + e)
                        .length,
                        j =
                        ...
                        if (b.multiple) {
                            if (
                                ...
                                if ((l && n) || (m && o))
                                    ...
                                    var q =
                                        'function' ==
                                        typeof b.options.maxOptionsText ?
                ...
                this.$searchbox.on('input propertychange', function() {
                    b.$searchbox.val() ?
                        (b.options.searchAccentInsensitive ?
                            ...
                            .parent()
                            .addClass('hide'),
                            b.$menu.find('li').filter(':visible:not(.no-results)')
                            .length ?
                            e.parent().length && e.remove() :
                            (e.parent().length && e.remove(),
                                e
